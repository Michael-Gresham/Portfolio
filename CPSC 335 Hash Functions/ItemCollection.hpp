...
public:
  ...
  //This method was create by me (student) to not be redundant when calculating the balance of each hash table.
  // it returns the difference between the highest bucket size and the lowest bucket size.
  unsigned int calculateBalance(CustomHashTable table);
